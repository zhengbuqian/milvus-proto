...
type SparseFloatArray struct {
	...
	// non zero values
	Nnz int32 `protobuf:"varint,3,opt,name=nnz,proto3" json:"nnz,omitempty"`
	// len(indptr) == rows + 1
	Indptr *IntArray `protobuf:"bytes,4,opt,name=indptr,proto3" json:"indptr,omitempty"`
	// len(indices) == nnz
...
func (m *SparseFloatArray) GetRows() int32 {
	if m != nil {
		return m.Rows
	}
	return 0
...
func (m *SparseFloatArray) GetIndptr() *IntArray {
	if m != nil {
		return m.Indptr
	}
	return nil
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
